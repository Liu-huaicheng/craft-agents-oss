...
const COMPAT_ANTHROPIC_DEFAULTS = 'claude-fable-5, claude-opus-4-8, claude-opus-4-7, claude-sonnet-4-6, claude-haiku-4-5'
        ...
        <div className="space-y-2">
          ...
          <div className={cn(
            ...
            <Input
              ...
              placeholder="e.g. claude-fable-5, claude-opus-4-8, claude-sonnet-4-6, claude-haiku-4-5"
              className="border-0 bg-transparent shadow-none"
              disabled={isDisabled}
            />
          </div>
